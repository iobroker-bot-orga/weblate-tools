...
const { WEBLATE_URL, REQUEST_TIMEOUT_MS, WEBLATE_MAX_CONCURRENCY } = require('./config');
...
async function markComponentNeedsEditing(project, component, options = {}) {
    ...
    const concurrency = Math.min(WEBLATE_MAX_CONCURRENCY, options.concurrency || WEBLATE_MAX_CONCURRENCY);
